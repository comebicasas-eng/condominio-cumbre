...
function handleSubmit(event) {
  ...
  const vj_localizacion = "QUERETARO";
  const vj_plaza = "QRO";
  const vj_fraccionamiento = "CM";
  const vj_nombre_micrositio = "Cumbres del Marques";
  let vj_campania = "";
  ...
  const RutaBrochure =
    "http://casascomebi.mx/catalogos-casas-muestra/CUMBRES_MARQUES_TLMK.pdf";
  ...
  fetch(
    "https://www.calypsonet.mx:8440/telemarketing_rst_visualiza_referidos/rest/telemarketing_rst/post_guarda_referido_web_Landing",
    {
      method: "POST",
      headers: {
